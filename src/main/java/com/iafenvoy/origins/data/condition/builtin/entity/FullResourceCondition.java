...
public record FullResourceCondition(ResourceLocation resource) implements EntityCondition {
    public static final MapCodec<FullResourceCondition> CODEC = RecordCodecBuilder.mapCodec(i -> i.group(
