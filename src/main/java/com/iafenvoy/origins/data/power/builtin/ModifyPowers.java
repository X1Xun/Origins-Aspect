...
public final class ModifyPowers {
    ...
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ModifyEnchantmentDamageDealtPower>> MODIFY_ENCHANTMENT_DAMAGE_DEALT = REGISTRY.register("modify_enchantment_damage_dealt", () -> ModifyEnchantmentDamageDealtPower.CODEC);
    public static final DeferredHolder<MapCodec<? extends Power>, MapCodec<ModifyEnchantmentDamageTakenPower>> MODIFY_ENCHANTMENT_DAMAGE_TAKEN = REGISTRY.register("modify_enchantment_damage_taken", () -> ModifyEnchantmentDamageTakenPower.CODEC);
