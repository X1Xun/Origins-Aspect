...
public class ModifyEnchantmentDamageTakenPower extends Power implements ModifierPowerHelper {
    public static final MapCodec<ModifyEnchantmentDamageTakenPower> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public ModifyEnchantmentDamageTakenPower(BaseSettings settings, Holder<Enchantment> enchantment, float baseValue, DamageCondition damageCondition, BiEntityCondition biEntityCondition, List<Modifier> modifier, BiEntityAction biEntityAction) {
        super(settings);
